...
export const metadata: Metadata = {
  ...
  title: 'Hub de Videos | GONOVI',
  description: 'Tutoriales, guías y operativas en vivo para mejorar tu lectura de mercado. Aprende Pine Script, estrategias y gestión de riesgo.',
  alternates: {
